...
- payload: (\[AdminSignUpWithEmailPassword]\(../../../../../types/HttpTypes/interfaces/types.HttpTypes.AdminSignUpWithEmailPassword/page.mdx) \\| \`Record\<string, unknown>\`) The data to pass in the request's body for authentication. When using the \`emailpass\` provider,
...
- Promise: (Promise\&#60;string\&#62;) The JWT token used for registration later.
